...
function Chatbot() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      >
        <ul className="p-4 space-y-2 flex-grow">
          ...
          <li>
            ...
            >
              <img src="/bot.png" alt="Chatbot" className="h-6 mr-2" />
              Chatbot
            </button>
          </li>
          <li>
      ...
      {/* Content */}
      <div
        className={`flex-1 mt-14 bg-gray-100 transition-all ${
          isSidebarOpen ? "lg:ml-64" : "ml-0"
        }`}
      >
        {/* Title */}
        <div className="px-4 py-4 bg-gray-100 rounded-md ml-2 mt-4">
          <h1 className="text-2xl font-bold text-gray-800">Chatbot Page</h1>
        </div>
        
        {/* Chatbot Section */}
        <div className="rounded-md p-6 mx-4">
          <div className="space-y-6">
            ...
            <div className="flex justify-center">
              <img
                src="/chatbot.png"
                alt="Chatbot Preview"
                className="w-100 sm:w-3/4 rounded-lg shadow-xl"
              />
            </div>

            {/* Button */}
            <div className="text-center mt-8">
              <a href="https://ai-reporting.showcaseai.online/" className="mt-8">
                <button className="px-8 py-4 bg-[#3e2b95] text-white rounded-lg hover:bg-[#534593] transition duration-300">
                  Use Now
                </button>
              </a>
            </div>
